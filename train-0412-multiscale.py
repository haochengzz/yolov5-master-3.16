...
def parse_opt(known=False):
    ...
    parser.add_argument('--data', type=str, default=ROOT / 'Project/cgaoi/config/VOC.yaml', help='dataset.yaml path')
    parser.add_argument('--hyp', type=str, default=ROOT / 'Project/cgaoi/config/hyp.scratch-low.yaml', help='hyperparameters path')
    ...
    parser.add_argument('--sync-bn',default=True, action='store_true', help='use SyncBatchNorm, only available in DDP mode')
